...
//Force it for ReactOS
//#define MS_WINDOWS 1

//#define HAVE_DECLSPEC_DLL 1

#define USE_DL_EXPORT 1

//Use Windows config for ReactOS
...
#define PYLONG_BITS_IN_DIGIT 15 //For ReactOS. See longintrepr.h
...
#define Py_DEBUG 1 //Define for ReactOS debug build
...
#define SIZEOF_LONG 4 //Change for ReactOS 32-bit build
...
#define SIZEOF_VOID_P 4 //Change to 4 for 32 bit ReactOS build
